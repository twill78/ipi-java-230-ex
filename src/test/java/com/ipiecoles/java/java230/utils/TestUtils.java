package com.ipiecoles.java.java230.utils;
...
public class TestUtils {
    ...
    public static final String PACKAGE = "com.ipiecoles.java.java230.model.";
    public static final String PACKAGE_REPOSITORY = "com.ipiecoles.java.java230.repository.";
    public static final String PACKAGE_SERVICE = "com.ipiecoles.java.java230.service.";
    ...
    public static Class<?> getClasse(String classe) throws ClassNotFoundException {
        ...
        String pack = classe.contains("Repository") ? PACKAGE_REPOSITORY : classe.contains("Service") ? PACKAGE_SERVICE : PACKAGE;
        return Class.forName(classe.contains(".") ? classe : pack + classe);
    }
